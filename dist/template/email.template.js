...
export const welcomeEmailTemplate = (firstName, email) => {
    return `
    <!DOCTYPE html>
    <html>
    <head>
...
export const passwordResetTemplate = (firstName, resetToken) => {
...
export const orderConfirmationTemplate = (firstName, orderId, total) => {
    return `
    <!DOCTYPE html>
    <html>
    <head>
